...
const Header = ({
    ...
    if (type === "main") {
      return (
        <header className="sticky top-0 z-50 flex h-15 w-full items-center justify-between bg-[#F5F5F5] px-4">
          ...
          <div className="flex items-center gap-7 text-[#969DB4]">
            <button
              type="button"
              aria-label="스캔"
  ...
  return (
    <header className="sticky top-0 z-50 flex h-14 w-full items-center justify-center bg-white px-4 text-black">
      <button
        type="button"
        onClick={() => router.back()}
